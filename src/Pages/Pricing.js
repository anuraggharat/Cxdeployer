...
export default () => {
  ...
  return (
    <section className="Pricing" id="pricinghome">
      <div id="pricing" className="mt-5">
        <PricingFeatures />
      </div>
      <div className="container mt-5">
        <div className="h2  pricing-lead text-center">
          Simple pricing for customer experience transformation.
        </div>
        <div className="h4  pricing-lead-second text-center">
          No start up fees, no credit card and no commitment.
        </div>
        <div className="row">
            ...
            <div className="card mb-5 mb-lg-0 h-100">
              <div className="card-body">
                ...
                <h6 className="card-price text-center">
                  $0<span className="period"> per user/month</span>
                </h6>
                <hr />

...
const features = [
	...
	["Customer Journey Map", "1", "Unlimited", "Unlimited", "Unlimited", "Customer Journey Map"],
	["Buisness Canvas Modal", "1", "Unlimited", "Unlimited", "Unlimited", "Buisness Modal Canvas"],
	["Personas", "1", "Unlimited", "Unlimited", "Unlimited", "Unlimited", "Persons"],
	["Ideations", 0, "Unlimited", "Unlimited", "Unlimited", "Ideation"],
	["Khanban Boards", 0, "Unlimited", "Unlimited", "Unlimited", "Khanban Boards"],
	["Comments", 0, "Unlimited", "Unlimited", "Unlimited", "Comments"],
	["Views", "Unlimited", "Unlimited", "Unlimited", "Unlimited", "Views"],
	["Export to", "PDF & PNG", "PDF, PNG & SVG", "PDF, PNG & SVG", "PDF, PNG & SVG"],
	["Storage", "50MB", "1GB", "Unlimited", "Unlimited", "Storage"],
	["Audit Trial", true, true, true, true],
	["Support", "Community", "Email", "Live chat & Email", "Single Sign-On", "Support"]
]
		...
		<table className="table table-borderless table-hover">
			<thead className="border-bottom">
				<tr className="text-center">
					...
					<th>Free</th>
					<th className="bg-info text-white"> <div className="p-1 rounded">$10</div> Startup</th>
					<th className="bg-info text-white"> <div className="p-1 rounded">$20</div> Growth</th>
					<th>Enterpise</th>
				</tr>
			</thead>
			<tbody>
